...
public class Operar_Volumen_Cilindro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_operar__volumen__cilindro);
    ...
    public void  Aceptar(View v){
        if (base.getText().length()==0 ||alt.getText().length()==0 ){
            ...
            String r = Datos.CalcularVolumenCilindro(ba,al);
            principal.Titulo_Resultado = resources.getString(R.string.cilindro);
            principal.Titulo_datos = "Volumen : " + r;
            in = new Intent(Operar_Volumen_Cilindro.this,resultado.class);
            startActivity(in);
        }
    }
